...
var grungeAlbumsJSONredo = JSON.parse(grungeAlbumsJSON);
...
var grungeAlbumsBreakdown = grungeAlbumsJSONredo;

console.log(grungeAlbumsBreakdown);

grungeAlbumsBreakdown.albums.forEach(album => {
...
var profileJsObject = JSON.stringify(rosie);
console.log(profileJsObject);
profileJsObject.location = "Queens";
console.log(profileJsObject);
var rosie = JSON.parse(profileJsObject);
// Converting it back to the original overrides the originial information
